<div align="center">  
  <h2><b> Space Travelers' Hub - Capstone </b></h2>
  <img src='./src/assets/planet.png' width='80px' height='auto' alt='logo'>
</div>
...
**Space Travelers' Hub** A Single Page App with React-Redux having three sub-pages, Rockets, Missions and MyProfile. The Rockets and Missions subpages Renders an external API's data. MyProfile page displays the Rockets and Missions that are reserved and joined respectively.
...
- **Can Display Data from external API with help of middleware in Rockets and Missions pages.**

- **Rockets Component has `Reserve` a Rocket and `Cancel Reservations` for a Rocket features.**
...
Project Bookstore is a Single Page App with React having two sub-pages which includes an store of books and display all the books added within the subpage. There is also another subpage `/categories` but for now this subpage is empty.
...
```sh
  cd my-folder
  git clone git@github.com:tan12082001/react-group-capstone.git
```
...
- [ ] **Apply more styles for the MyProfile page**

- [ ] **Include Wiki References for missions and rockets**
...
For Free Source APIs used in the Project:

  Rockets API: [API](https://api.spacexdata.com/v4/rockets)

  Missions API: [API](https://api.spacexdata.com/v3/missions)
